...
public class InventoryClick : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
{
    ...
    {
        commonVariable.currentItemCode = commonVariable.currentTheme * 16 + index;
